...
pub fn request(file: u32, slice: u32) -> Message {
  Message { mtype: 1, slice, last_slice: 0, file, body: vec![] }
}

pub fn response(req: Message, body: Vec<u8>, last_slice: u32) -> Message {
  Message { mtype: 2, last_slice, body, ..req }
}
